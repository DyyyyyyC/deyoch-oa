...
-- ----------------------------
INSERT INTO `deyoch_announcement` VALUES (1, '元旦放假通知', '根据国家法定节假日安排，2026年元旦放假时间为2026年1月1日至1月3日，共3天。', '张三', '2025-12-25 10:00:00', 1, '2025-12-31 10:02:42', '2025-12-31 10:02:42');
INSERT INTO `deyoch_announcement` VALUES (2, '系统升级通知', 'OA系统将于2025年12月31日22:00-24:00进行系统升级，期间系统将暂停服务，请提前做好准备。', '李四', '2025-12-28 14:30:00', 1, '2025-12-31 10:02:42', '2025-12-31 10:02:42');
INSERT INTO `deyoch_announcement` VALUES (3, '年度优秀员工评选', '2025年度优秀员工评选活动正式启动，请各部门推荐候选人。', '王五', '2025-12-20 09:00:00', 1, '2025-12-31 10:02:42', '2025-12-31 10:02:42');
INSERT INTO `deyoch_announcement` VALUES (5, '公司年会通知', '2026年公司年会将于2026年1月15日举行，请各位员工安排好时间。', '赵六', '2025-12-26 16:00:00', 1, '2025-12-31 10:02:42', '2025-12-31 16:59:44');
...
-- ----------------------------
INSERT INTO `deyoch_dept` VALUES (1, '总公司', 0, '001', '张三', '13800138000', 'zhangsan@deyoch.com', 0, 1, '2025-12-25 15:00:51', '2025-12-25 15:00:51');
INSERT INTO `deyoch_dept` VALUES (2, '技术部', 1, '001001', '李四', '13800138001', 'lisi@deyoch.com', 0, 1, '2025-12-25 15:00:51', '2025-12-25 15:00:51');
INSERT INTO `deyoch_dept` VALUES (3, '市场部', 1, '001002', '王五', '13800138002', 'wangwu@deyoch.com', 0, 1, '2025-12-25 15:00:51', '2025-12-25 15:00:51');
INSERT INTO `deyoch_dept` VALUES (4, '财务部', 1, '001003', '赵六', '13800138003', 'zhaoliu@deyoch.com', 0, 1, '2025-12-25 15:00:51', '2025-12-25 15:00:51');
...
CREATE TABLE `deyoch_document`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '文档标题',
  ...
  `uploader` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '上传人',
...
-- ----------------------------
INSERT INTO `deyoch_document` VALUES (1, 'OA系统需求文档.docx', 'OA系统的详细需求分析文档', '/upload/documents/req.docx', 'req.docx', 1024000, 'docx', '张三', 2, 1, '2025-12-31 10:02:42', '2025-12-31 14:37:15');
INSERT INTO `deyoch_document` VALUES (2, '数据库设计文档.docx', 'OA系统数据库设计文档', '/upload/documents/db.docx', 'db.docx', 512000, 'docx', '李四', 2, 1, '2025-12-31 10:02:42', '2025-12-31 14:37:19');
INSERT INTO `deyoch_document` VALUES (3, '用户手册.pdf', 'OA系统用户操作手册', '/upload/documents/user_manual.pdf', 'user_manual.pdf', 2048000, 'pdf', '王五', 1, 1, '2025-12-31 10:02:42', '2025-12-31 14:37:25');
INSERT INTO `deyoch_document` VALUES (4, '开发规范.docx', 'OA系统开发规范文档', '/upload/documents/dev_spec.docx', 'dev_spec.docx', 768000, 'docx', '赵六', 2, 1, '2025-12-31 10:02:42', '2025-12-31 14:37:28');
INSERT INTO `deyoch_document` VALUES (5, '测试报告.pdf', 'OA系统测试报告', '/upload/documents/test_report.pdf', 'test_report.pdf', 1536000, 'pdf', '钱七', 2, 1, '2025-12-31 10:02:42', '2025-12-31 14:37:30');
...
CREATE TABLE `deyoch_process_instance`  (
  ...
  `initiator` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发起人',
...
-- ----------------------------
INSERT INTO `deyoch_process_instance` VALUES (1, 1, '张三请假申请', '张三', '2025-12-25 09:00:00', '2025-12-26 10:00:00', 1, '2025-12-31 10:02:42', '2025-12-31 10:02:42');
INSERT INTO `deyoch_process_instance` VALUES (2, 2, '李四报销申请', '李四', '2025-12-27 14:00:00', NULL, 0, '2025-12-31 10:02:42', '2025-12-31 10:02:42');
INSERT INTO `deyoch_process_instance` VALUES (3, 3, '王五出差申请', '王五', '2025-12-28 10:00:00', NULL, 0, '2025-12-31 10:02:42', '2025-12-31 10:02:42');
INSERT INTO `deyoch_process_instance` VALUES (4, 1, '赵六请假申请', '赵六', '2025-12-29 08:30:00', NULL, 0, '2025-12-31 10:02:42', '2025-12-31 10:02:42');
INSERT INTO `deyoch_process_instance` VALUES (5, 4, '钱七采购申请', '钱七', '2025-12-30 11:00:00', '2025-12-30 15:00:00', 1, '2025-12-31 10:02:42', '2025-12-31 10:02:42');
...
-- ----------------------------
INSERT INTO `deyoch_schedule` VALUES (1, '项目评审会议', 'OA系统项目评审', 1, '2025-12-31 10:00:00', '2025-12-31 12:00:00', '会议室A', 1, '2025-12-31 10:02:42', '2025-12-31 10:02:42');
...
INSERT INTO `deyoch_schedule` VALUES (4, '112', '', 1, '2026-01-04 00:00:00', '2026-01-05 00:00:00', '', 0, '2026-01-04 15:09:06', '2026-01-04 15:09:16');
...
CREATE TABLE `deyoch_task`  (
  ...
  `assignee` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '负责人',
...
-- ----------------------------
INSERT INTO `deyoch_task` VALUES (1, '完成项目设计', '完成OA系统的项目设计文档', '张三', '管理员', 3, 1, '2025-12-25 09:00:00', '2025-12-31 18:00:00', '2025-12-31 10:02:42', '2025-12-31 17:03:24');
INSERT INTO `deyoch_task` VALUES (2, '修复系统bug', '修复用户管理模块的bug', '张三', '管理员', 2, 1, '2025-12-26 10:00:00', '2025-12-28 17:00:00', '2025-12-31 10:02:42', '2025-12-31 17:03:27');
INSERT INTO `deyoch_task` VALUES (3, '编写测试用例', '编写系统测试用例', '张三', '管理员', 2, 0, '2025-12-29 09:00:00', '2025-12-31 18:00:00', '2025-12-31 10:02:42', '2025-12-31 17:03:27');
INSERT INTO `deyoch_task` VALUES (4, '部署生产环境', '部署OA系统到生产环境', '张三', '管理员', 3, 2, '2025-12-20 08:00:00', '2025-12-22 17:00:00', '2025-12-31 10:02:42', '2025-12-31 17:03:27');
INSERT INTO `deyoch_task` VALUES (5, '需求分析', '分析新需求', '张三', '管理员', 2, 0, '2025-12-30 09:00:00', '2025-01-03 18:00:00', '2025-12-31 10:02:42', '2025-12-31 17:03:27');
